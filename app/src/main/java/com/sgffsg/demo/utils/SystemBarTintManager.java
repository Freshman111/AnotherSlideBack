...
public class SystemBarTintManager {
    ...
    static {
        try {
            ...
            String versionName = (String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name");
            int versionCode = Integer.parseInt(versionName.substring(1, versionName.length()));
            if (versionCode >= 6) {
                sIsMiuiV6 = true;
            }
        } catch (Exception e) {
